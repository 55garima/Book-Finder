...
So what are you waiting for? Search your favorite book right now!
...
- Allows users to search books by title, author, and ISBN number.
- Allows users to read the preview of the book.
- Generate a picture of the book along with an external link to see a preview of the book on Google Books.
